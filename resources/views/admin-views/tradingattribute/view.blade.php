...
<div class="content container-fluid">
    ...
    <div class="mb-3">
        <h2 class="h1 mb-0 d-flex gap-2">
            ...
            {{\App\CPU\translate('Trading_Attribute_Setup')}}
        </h2>
    </div>
    <!-- End Page Title -->
        ...
        <div class="col-md-12 mb-3">
            <div class="card">
                ...
                <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <form action="{{route('admin.trading-attribute.store')}}" method="post">
                        @csrf
                                    ...
                                    <td>
                                       <div class="d-flex justify-content-center gap-2">
                                            <a class="btn btn-outline-info btn-sm square-btn"
                                                ...
                                                href="{{route('admin.trading-attribute.edit',[$attribute->id])}}">
                                                <i class="tio-edit"></i>
                                            </a>
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin.trading-attribute.delete')}}",
                        method: 'POST',
                        data: {id: id},
                        success: function () {
