...
@section('title', \App\CPU\translate('List of Breed'))
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                ...
                {{\App\CPU\translate('breed')}} {{\App\CPU\translate('List')}}
                <span class="badge badge-soft-dark radius-50 fz-14">{{ count($br) }}</span>
            </h2>
        </div>
        <!-- End Page Title -->
                        ...
                        <div class="row g-2 flex-grow-1">
                            ...
                            <div class="col-sm-4 col-md-6 col-lg-8 d-flex justify-content-end">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('admin.trading-breed.export') }}">Excel</a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- End Row -->
                        ...
                        <div class="table-responsive">
                            <table style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                                ...
                                <tr>
                                    ...
                                    <th>{{ \App\CPU\translate('Breed_Logo')}}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img class="rounded avatar-60"
                                                 ...
                                                 src="{{asset('storage/app/public/trading-breed')}}/{{$b->image}}">
                                        </td>
                                        <td>{{$b->name}}</td>
                                        <td>
...
@push('script')
    <script>
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin.trading-breed.delete')}}",
                        method: 'POST',
                        data: {id: id},
                        success: function () {
                            toastr.success('{{ \App\CPU\translate('Breed_deleted_successfully')}}');
                            location.reload();
                        }
                    });
                }
        ...
        $(document).on('change', '.status', function () {
            ...
            $.ajax({
                url: "{{route('admin.trading-breed.status-update')}}",
                method: 'POST',
                data: {
                    id: id,
                    status: status
