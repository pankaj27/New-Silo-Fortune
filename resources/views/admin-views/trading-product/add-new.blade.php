    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                ...
                {{\App\CPU\translate('Add')}} {{\App\CPU\translate('New')}} {{\App\CPU\translate('Trading Products')}}
            </h2>
        </div>
        <!-- End Page Title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="product-form" action="{{ route('admin.trading-product.store') }}" method="POST"
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-4">
                                <label for="name" class="title-color">{{ \App\CPU\translate('Trading_Category') }}</label>
                            ...
                            <div class="col-md-4">
                                <label for="name" class="title-color">{{ \App\CPU\translate('Trading_Breed') }}</label>
                                <select
                        ...
                        <div class="card-body">
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-3 form-group physical_product_show" >
                                    ...
                                    <div>
                                        <input type="radio" name="is_pregnent"  value="0" required="required"> No<br>
                        ...
                        <div class="card-body">
                            <div class="row align-items-end">
                                <div class="col-md-3 form-group">
                                    ...
                                    @foreach ($users as $b)
                                        <option value="{{ $b->id }}">{{ $b->f_name }} {{ $b->l_name }} -({{ $b->phone }})</option>
                                    @endforeach
                                </select>
                                ...
                                <div class="col-md-3 form-group physical_product_show" >
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="sller_contact"  id="sller_contact"  value="" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 form-group physical_product_show" >
                                    ...
                                    <option value="{{ null }}" selected disabled>
                                        ---{{ \App\CPU\translate('Select') }}---</option>
                                      <?php  
                                            $citynn = DB::table('cities')->where('country_code','IN')->where('state_code','KA')->orderBy('state_id', 'asc')->get();
                                        ?>
                                        @foreach ($citynn as $cityy)
                                            <?php 
                                                $statename = DB::table('states')->where('id',$cityy->state_id)->first();
                                            ?>
                                                <option value="{{ $cityy->id }}">{{ $cityy->name }}, {{$statename->name}}</option>
                                        @endforeach
                                    </select> 
                                </div>
                                ...
                                <div class="col-md-3 form-group physical_product_show">
                                    ...
                                    <option value="{{ null }}" selected disabled>
                                        ...
                                        <option value="3">Sent for Verification</option>
                                        <option value="4">Drop from Web</option>
                                    </select>   
