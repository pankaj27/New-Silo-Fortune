            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                        <form action="{{route('admin.trading-sub-category.store')}}" method="POST">
                            @csrf
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="exampleFormControlSelect1" name="parent_id"
                                            ...
                                            @foreach(DB::table('trading_categories')->where(['position'=>0])->get() as $category)
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <a class="btn btn-outline-info btn-sm square-btn"
                                                ...
                                                href="{{route('admin.trading-sub-category.edit',[$category->id])}}">
                                                <i class="tio-edit"></i>
                                            </a>
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin.trading-sub-category.delete')}}",
                        method: 'POST',
                        data: {id: id},
                        success: function () {
