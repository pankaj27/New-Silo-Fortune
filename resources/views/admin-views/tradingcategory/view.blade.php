    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-10">
                ...
                {{\App\CPU\translate('TradingCategories')}} {{\App\CPU\translate('Setup')}}
            </h2>
        </div>
        <!-- End Page Title -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                        <form action="{{route('admin.tradingcategory.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                                <h5 class="text-capitalize d-flex gap-1">
                                    {{ \App\CPU\translate('trading_category_list')}}
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img class="rounded" width="64"
                                                ...
                                                src="{{asset('storage/app/public/trading_category')}}/{{$category->icon}}">
                                    </td>
                                    <td>{{$category->name}}</td>
                                    <td>
                                        {{$category->priority}}
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-10">
                                            <a class="btn btn-outline-info btn-sm square-btn"
                                                ...
                                                href="{{route('admin.tradingcategory.edit',[$category->id])}}">
                                                <i class="tio-edit"></i>
                                            </a>
  ...
  $('[data-toggle="tooltip"]').tooltip()
    ...
    <script>
        $(document).on('change', '.category-status', function () {
            ...
            $.ajax({
                url: "{{route('admin.tradingcategory.status')}}",
                method: 'POST',
                data: {
                    id: id,
                    home_status: status
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin.tradingcategory.delete')}}",
                        method: 'POST',
                        data: {id: id},
                        success: function () {
