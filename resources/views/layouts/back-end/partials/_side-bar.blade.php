                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <!--Product Management Ends-->
                         ...
                         <!--Animal Trading Management -->
                         
                         @if(\App\CPU\Helpers::module_permission_check('product_management'))
                            <li class="nav-item {{( Request::is('admin/tradingcategory*') || Request::is('admin/trading-sub*') || Request::is('admin/tradingattribute*') || Request::is('admin/tradingproduct*'))?'scroll-here':''}}">
                                <small class="nav-subtitle"
                                       title="">{{\App\CPU\translate('trading_management')}}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                            <!-- Pages -->
                            <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/category*') ||Request::is('admin/sub*')) ?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:" title="{{\App\CPU\translate('tradingCategory_Setup')}}">
                                    <i class="tio-filter-list nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{\App\CPU\translate('tradingCategory_Setup')}}
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{(Request::is('admin/tradingcategory*') ||Request::is('admin/trading-sub-category*'))?'block':''}}">
                                    <li class="nav-item {{Request::is('admin/tradingcategory/view')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.tradingcategory.view')}}"
                                           title="{{\App\CPU\translate('Categories')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('TradingCategories')}}</span>
                                        </a>
                                    </li>
                                    <!--<li class="nav-item {{Request::is('admin/trading-sub-category/view')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.trading-sub-category.view')}}"
                                           title="{{\App\CPU\translate('Trading_Sub_Categories')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('Trading_Sub_Categories')}}</span>
                                        </a>
                                    </li>-->
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/trading-breed*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:" title="{{\App\CPU\translate('trading_breed')}}">
                                    <i class="tio-star nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CPU\translate('trading_breed')}}</span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{Request::is('admin/trading-breed*')?'block':'none'}}">
                                    <li class="nav-item {{Request::is('admin/trading-breed/add-new')?'active':''}}"
                                        title="{{\App\CPU\translate('add_new')}}">
                                        <a class="nav-link " href="{{route('admin.trading-breed.add-new')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('add_new')}}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{Request::is('admin/trading-breed/list')?'active':''}}"
                                        title="{{\App\CPU\translate('breed_list')}}">
                                        <a class="nav-link " href="{{route('admin.trading-breed.list')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('breed_list')}}</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                           
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/trading-attribute*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.trading-attribute.view')}}"
                                   title="{{\App\CPU\translate('Product_Trading_Attributes')}}">
                                    <i class="tio-category-outlined nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CPU\translate('Product_Trading_Attributes')}}</span>
                                </a>
                            </li>
                            
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/trading-testimonial*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.trading-testimonial.view')}}"
                                   title="{{\App\CPU\translate('Trading_testimonial')}}">
                                    <i class="tio-quotes nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CPU\translate('Trading_testimonial')}}</span>
                                </a>
                            </li>
                            
                            <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/trading-product/list/in_house') || Request::is('admin/trading-product/bulk-import') || (Request::is('admin/trading-product/add-new')) || (Request::is('admin/trading-product/view/*')) || (Request::is('admin/trading-product/barcode/*')))?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:" title="{{\App\CPU\translate('InHouse Trading Products')}}">
                                    <i class="tio-shop nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <span class="text-truncate">{{\App\CPU\translate('InHouse Trading Products')}}</span>
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{(Request::is('admin/trading-product/list/in_house') || (Request::is('admin/trading-product/stock-limit-list/in_house')) || (Request::is('admin/trading-product/bulk-import')) || (Request::is('admin/trading-product/add-new')) || (Request::is('admin/trading-product/view/*')) || (Request::is('admin/trading-product/barcode/*')))?'block':''}}">
                                    <li class="nav-item {{(Request::is('admin/trading-product/list/in_house') || (Request::is('admin/trading-product/add-new')) || (Request::is('admin/trading-product/view/*')) || (Request::is('admin/trading-product/barcode/*')))?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.trading-product.list',['in_house', ''])}}"
                                           title="{{\App\CPU\translate('Trading Products')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('Trading Products')}}</span>
                                        </a>
                                    </li>
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/trading-product/list/seller*')||Request::is('admin/trading-product/updated-product-list')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:"
                                   title="{{\App\CPU\translate('Seller')}} {{\App\CPU\translate('Trading_Products')}}">
                                    <i class="tio-airdrop nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{\App\CPU\translate('Seller')}} {{\App\CPU\translate('Traading_Products')}}
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{Request::is('admin/trading-product/list/seller*')||Request::is('admin/trading-product/updated-product-list')?'block':''}}">

                                    @if (\App\CPU\Helpers::get_business_settings('product_wise_shipping_cost_approval')==1)
                                        <li class="nav-item {{Request::is('admin/trading-product/updated-product-list')?'active':''}}">
                                            <a class="nav-link" title="{{\App\CPU\translate('updated_products')}}"
                                               href="{{route('admin.trading-product.updated-product-list')}}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="text-truncate">{{\App\CPU\translate('updated_products')}} </span>
                                            </a>
                                    ...
                                    @endif
                                    <li class="nav-item {{str_contains(url()->current().'?status='.request()->get('status'),'/admin/trading-product/list/seller?status=0')==1?'active':''}}">
                                        <a class="nav-link"
                                           title="{{\App\CPU\translate('New')}} {{\App\CPU\translate('Products')}}"
                                           href="{{route('admin.trading-product.list',['seller', 'status'=>'0'])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{\App\CPU\translate('New')}} {{\App\CPU\translate('Products')}} </span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{str_contains(url()->current().'?status='.request()->get('status'),'/admin/trading-product/list/seller?status=1')==1?'active':''}}">
                                        <a class="nav-link"
                                           title="{{\App\CPU\translate('Approved')}} {{\App\CPU\translate('Products')}}"
                                           href="{{route('admin.trading-product.list',['seller', 'status'=>'1'])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{\App\CPU\translate('Approved')}} {{\App\CPU\translate('Products')}}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{str_contains(url()->current().'?status='.request()->get('status'),'/admin/trading-product/list/seller?status=2')==1?'active':''}}">
                                        <a class="nav-link"
                                           title="{{\App\CPU\translate('Denied')}} {{\App\CPU\translate('Products')}}"
                                           href="{{route('admin.trading-product.list',['seller', 'status'=>'2'])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{\App\CPU\translate('Denied')}} {{\App\CPU\translate('Products')}}</span>
                                        </a>
                        ...
                        @endif
                         ...
                         <!-- End of Animal Trading Management --->
