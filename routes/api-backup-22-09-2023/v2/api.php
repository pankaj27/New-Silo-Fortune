...
Route::group(['namespace' => 'api\v2', 'prefix' => 'v2', 'middleware' => ['api_lang']], function () {
    Route::group(['prefix' => 'seller', 'namespace' => 'seller'], function () {
        ...
        //NEW ADDITION 
        Route::get('shop-info-trading', 'SellerController@shop_info_trading');
        Route::get('seller-info-trading', 'SellerController@seller_info_trading');
        Route::get('trading-shop-product-reviews', 'SellerController@trading_shop_product_reviews');
        ...
        Route::group(['prefix' => 'breeds'], function () {
            Route::get('/', 'BrandController@getBreeds');
        });
        ...
        Route::group(['prefix' => 'products'], function () {
            ...
            //new addition 
            Route::post('upload-trading-digital-product', 'ProductController@upload_trading_digital_product');
            Route::post('trading-upload-images', 'ProductController@upload_trading_images');
            Route::post('trading-add', 'ProductController@add_new_trading');
            //Route::get('trading-list', 'ProductController@list_trading');
