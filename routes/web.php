...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    //trading products 
    Route::get('animal-trading', 'AnimalTradingController@index')->name('animal-trading');
    Route::post('animal-trading/search-by-category', 'AnimalTradingController@searchByCategory')->name('search-by-category');
    Route::get('animal-trading/vie-all-category', 'AnimalTradingController@vieAllCategory')->name('view-all-category');
    Route::get('animal-trading/details-items/{slug}', 'AnimalTradingController@detailsItemDescroption')->name('details-item-view');
    Route::get('animal-trading/view-all-ads', 'AnimalTradingController@viewAllAds')->name('view-all-ads');
    Route::get('animal-trading/search-by-location/{location_id}', 'AnimalTradingController@searchByLocation')->name('search-by-location');
    Route::get('animal-trading/search-by-all-location', 'AnimalTradingController@searchByAllLocation')->name('search-by-all-location');
    Route::get('animal-trading/add-product', 'AnimalTradingController@addProduct')->name('add-product');
    Route::get('animal-trading/my-listing', 'AnimalTradingController@myListing')->name('my-listing');
    //Route::get('animal-trading/search-by-location', 'AnimalTradingController@searchByLocation')->name('search-by-location');
