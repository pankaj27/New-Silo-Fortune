...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'category', 'as' => 'category.','middleware'=>['module:product_management']], function () {
            ...
            Route::get('editNew/{id}', 'CategoryController@editNew')->name('editNew');
            Route::post('updateNew/{id}', 'CategoryController@updateNew')->name('updateNew');
            Route::post('deleteNew', 'CategoryController@deleteNew')->name('delete');
         ...
         Route::group(['prefix' => 'tradingcategory', 'as' => 'tradingcategory.','middleware'=>['module:product_management']], function () {
            Route::get('view', 'CategoryController@tradingindex')->name('view');
            Route::get('fetch', 'CategoryController@tradingfetch')->name('fetch');
            Route::post('store', 'CategoryController@tradingstore')->name('store');
            Route::get('edit/{id}', 'CategoryController@tradingedit')->name('edit');
            Route::post('update/{id}', 'CategoryController@tradingupdate')->name('update');
            Route::post('delete', 'CategoryController@tradingdelete')->name('delete');
            Route::post('status', 'CategoryController@tradingstatus')->name('status');
        });
         
         
        
         /*=================================== Ends Trading Category  ============================================================*/
        ...
        Route::group(['prefix' => 'sub-category', 'as' => 'sub-category.','middleware'=>['module:product_management']], function () {
            ...
            Route::post('deleteNew', 'SubCategoryController@deleteNew')->name('deleteNew');
        });
        
        /*=================================== Trading SUb Category  ============================================================*/
        
        Route::group(['prefix' => 'trading-sub-category', 'as' => 'trading-sub-category.','middleware'=>['module:product_management']], function () {
            Route::get('view', 'SubCategoryController@tradingindex')->name('view');
            Route::get('fetch', 'SubCategoryController@tradingfetch')->name('fetch');
            Route::post('store', 'SubCategoryController@tradingstore')->name('store');
            Route::post('edit', 'SubCategoryController@tradingedit')->name('edit');
            Route::post('update', 'SubCategoryController@tradingupdate')->name('update');
            Route::post('delete', 'SubCategoryController@tradingdelete')->name('delete');
        });
        
        
        
        Route::group(['prefix' => 'trading-attribute', 'as' => 'trading-attribute.','middleware'=>['module:product_management']], function () {
            Route::get('view', 'AttributeController@tradingindex')->name('view');
            Route::get('fetch', 'AttributeController@tradingfetch')->name('fetch');
            Route::post('store', 'AttributeController@tradingstore')->name('store');
            Route::get('edit/{id}', 'AttributeController@tradingedit')->name('edit');
            Route::post('update/{id}', 'AttributeController@tradingupdate')->name('update');
            Route::post('delete', 'AttributeController@tradingdelete')->name('delete');
        });
        
        Route::group(['prefix' => 'trading-testimonial', 'as' => 'trading-testimonial.','middleware'=>['module:product_management']], function () {
            Route::get('add-new', 'TestimonialController@add_new')->name('add-new');
            Route::get('view', 'TestimonialController@index')->name('view');
            Route::get('fetch', 'TestimonialController@fetch')->name('fetch');
            ...
            Route::post('status-update', 'TestimonialController@status_update')->name('status-update');
        });
        
        
         /*=================================== Ends Trading Sub Category  ============================================================*/
        ...
        /*================================================== Trading Breed==============================================================*/
         ...
         Route::group(['prefix' => 'trading-breed', 'as' => 'trading-breed.','middleware'=>['module:product_management']], function () {
            Route::get('add-new', 'TradingBreedController@add_new')->name('add-new');
            Route::post('add-new', 'TradingBreedController@store');
            Route::get('list', 'TradingBreedController@list')->name('list');
            Route::get('update/{id}', 'TradingBreedController@edit')->name('update');
            Route::post('update/{id}', 'TradingBreedController@update');
            Route::post('delete', 'TradingBreedController@delete')->name('delete');
            Route::get('export', 'TradingBreedController@export')->name('export');
            Route::post('status-update', 'TradingBreedController@status_update')->name('status-update');
        });
        
        
        
        
        /*=====================================================End of Trading Breed ==============================================================*/
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.','middleware'=>['module:product_management']], function () {
            ...
            Route::get('get-user-address', 'ProductController@get_user_address')->name('get-user-address');
            Route::get('get-user-location-phone', 'ProductController@get_user_location_phone')->name('get-user-location-phone');
        });
        
        
        //==================================== Trading Product addition ==========================================================//
        
        
        Route::group(['prefix' => 'trading-product', 'as' => 'trading-product.','middleware'=>['module:product_management']], function () {
            Route::get('add-new', 'TradingProductController@add_new')->name('add-new');
            Route::post('store', 'TradingProductController@storeTradingProduct')->name('store');
            Route::get('remove-image', 'TradingProductController@remove_image')->name('remove-image');
            Route::post('status-update', 'TradingProductController@status_update')->name('status-update');
            Route::get('list/{type}', 'TradingProductController@list')->name('list');
            Route::get('export-excel/{type}', 'TradingProductController@export_excel')->name('export-excel');
            Route::get('stock-limit-list/{type}', 'TradingProductController@stock_limit_list')->name('stock-limit-list');
            Route::get('get-variations', 'TradingProductController@get_variations')->name('get-variations');
            Route::post('update-quantity', 'TradingProductController@update_quantity')->name('update-quantity');
            Route::get('edit/{id}', 'TradingProductController@edit')->name('edit');
            Route::post('update/{id}', 'TradingProductController@updateNew')->name('update');
            Route::post('featured-status', 'TradingProductController@featured_status')->name('featured-status');
            Route::get('approve-status', 'TradingProductController@approve_status')->name('approve-status');
            Route::post('deny', 'TradingProductController@deny')->name('deny');
            Route::post('sku-combination', 'TradingProductController@sku_combination')->name('sku-combination');
            Route::get('get-categories', 'TradingProductController@get_categories')->name('get-categories');
            Route::delete('delete/{id}', 'TradingProductController@delete')->name('delete');
            Route::get('updated-product-list','TradingProductController@updated_product_list')->name('updated-product-list');
            Route::post('updated-shipping','TradingProductController@updated_shipping')->name('updated-shipping');

            Route::get('view/{id}', 'TradingProductController@view')->name('view');
            Route::get('bulk-import', 'TradingProductController@bulk_import_index')->name('bulk-import');
            Route::post('bulk-import', 'TradingProductController@bulk_import_data');
            Route::get('bulk-export', 'TradingProductController@bulk_export_data')->name('bulk-export');
            Route::get('barcode/{id}', 'TradingProductController@barcode')->name('barcode');
            Route::get('barcode/generate', 'TradingProductController@barcode_generate')->name('barcode.generate');
        });
        
        
    //=============================================== End of Trading Product Addition ===============================================================================    
